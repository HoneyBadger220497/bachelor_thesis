...
\begin{figure}
    \centering
    \input{Diagrams/Graphs/on_grid.tex}
...
\begin{figure}[h!]
    \centering
    \input{Diagrams/Elements/undirectedGraphs.tex}
...
\begin{figure}
    ...
    \begin{subfigure}[c]{0.4\textwidth}
        \centering
        \input{Diagrams/Evaluation/uniqueSquareGraph.tex}
    \end{subfigure}
    \hspace{0.1\textwidth}
    \begin{subfigure}[c]{0.4\textwidth}
...
\begin{figure}
    ...
    \input{Diagrams/Evaluation/counterclockwiseSquareGraph.tex}
...
\begin{figure}[h!]
    \centering
    \input{Diagrams/Elements/directedGraphs.tex}
